...
//  Bankey
//
//  Created by Ivan Posavac on 06.12.2023..
//
...
class OnboardingContainerViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page1 = OnboardingViewController(heroImageName: "delorean", titleText: "Bankey is faster, easier to use, and has a branf new look and feel that will make feel like you are back in the 80s")
        let page2 = OnboardingViewController(heroImageName: "world", titleText: "Move your money around the worl quickly and securely")
    ...
    override func viewDidLoad() {
        ...
        private func layout() {
            //Close
            NSLayoutConstraint.activate([
                closeButtom.leadingAnchor.constraint(equalToSystemSpacingAfter: view.leadingAnchor, multiplier: 2),
